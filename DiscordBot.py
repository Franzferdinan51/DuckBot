...
@bot.tree.command(name="ask", description="Ask a question to the local LLM via LM Studio.") # <-- Changed this line
async def ask_command(interaction: discord.Interaction, prompt: str):
    ...
    try:
        ...
        await interaction.followup.send(ai_response) # <-- Changed to interaction.followup.send
